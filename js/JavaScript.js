...
function makeModalDraggable() {
    ...
    header.addEventListener('mousedown', (e) => {
        ...
        // 🌟 【行刑式修復 A】在轉成 absolute 之前，先抓取它原本完美的寬度並固定死！
        // 這樣它在脫離排版流時，就絕對不會縮水或變形
        const currentWidth = modalDialog.offsetWidth;
        modalDialog.style.width = currentWidth + 'px';

        // 💡 為了可以自由定位，強迫 dialog 轉成 absolute 模式
        modalDialog.style.position = 'absolute';

        // 🌟 【行刑式修復 B】徹底把所有方向的 margin 歸零，防範任何 Bootstrap 預設位移
